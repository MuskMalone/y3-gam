...
private:
	H2M::RefH2M<ImaGEShader> m_ShaderBloom;
	H2M::RefH2M<ImaGEShader> m_ShaderLightBox;
	H2M::RefH2M<ImaGEShader> m_ShaderBlur;
	H2M::RefH2M<ImaGEShader> m_ShaderBloomFinal;
