...
private:
	...
	H2M::RefH2M<ImaGEShader> m_ShaderMain;
	H2M::RefH2M<ImaGEShader> m_ShaderBackground;
	H2M::RefH2M<ImaGEShader> m_ShaderHybridAnimPBR;
	H2M::RefH2M<ImaGEShader> m_ShaderHDR;
	H2M::RefH2M<ImaGEShader> m_ShaderEquirectangularConversion;
	H2M::RefH2M<ImaGEShader> m_ShaderEnvFiltering;
	H2M::RefH2M<ImaGEShader> m_ShaderEnvIrradiance;
	H2M::RefH2M<ImaGEShader> m_ShaderBasic;
