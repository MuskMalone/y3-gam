...
void SceneEditorImGuizmo::SetUniformsShaderEditor(H2M::RefH2M<ImaGEShader> shaderEditor, H2M::RefH2M<ImaGETexture> texture, SceneObject* sceneObject)
{
    shaderEditor->Bind();
...
void SceneEditorImGuizmo::SetUniformsShaderEditorPBR(H2M::RefH2M<ImaGEShader> shaderEditorPBR, H2M::RefH2M<ImaGETexture> texture, H2M::RefH2M<Material> material, SceneObject* sceneObject)
{
...
void SceneEditorImGuizmo::SetUniformsShaderSkinning(H2M::RefH2M<ImaGEShader> shaderSkinning, SceneObject* sceneObject, float runningTime)
{
...
void SceneEditorImGuizmo::SetUniformsShaderHybridAnimPBR(H2M::RefH2M<ImaGEShader> shaderHybridAnimPBR, H2M::RefH2M<ImaGETexture> texture, SceneObject* sceneObject, float runningTime)
{
    RendererBasic::DisableCulling();
...
void SceneEditorImGuizmo::SetUniformsShaderWater(H2M::RefH2M<ImaGEShader> shaderWater, SceneObject* sceneObject, glm::mat4& projectionMatrix)
{
...
void SceneEditorImGuizmo::RenderLightSources(H2M::RefH2M<ImaGEShader> shaderGizmo)
{
    shaderGizmo->Bind();
...
void SceneEditorImGuizmo::RenderSkybox(H2M::RefH2M<ImaGEShader> shaderBackground)
{
    // m_BlurEffect->Render();
...
void SceneEditorImGuizmo::RenderLineElements(H2M::RefH2M<ImaGEShader> shaderBasic, glm::mat4 projectionMatrix)
{
