...
private:
	...
	H2M::RefH2M<ImaGEShader> m_ShaderCubemaps;
	H2M::RefH2M<ImaGEShader> m_ShaderCubemapsNanosuit;
	H2M::RefH2M<ImaGEShader> m_ShaderSkybox;
	H2M::RefH2M<ImaGEShader> m_ShaderBasic;
	H2M::RefH2M<ImaGEShader> m_ShaderFramebuffersScene;
