...
{
	m_ShaderPlanet = ImaGEShader::Create("Shaders/asteroids_planet.vs", "Shaders/asteroids.fs");
	printf("SceneAsteroids: m_ShaderPlanet shader compiled [programID=%d]\n", m_ShaderPlanet->GetProgramID());

	m_ShaderAsteroids = ImaGEShader::Create("Shaders/asteroids.vs", "Shaders/asteroids.fs");
