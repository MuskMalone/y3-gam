...
private:
	H2M::RefH2M<ImaGEShader> m_Shader_PBR;
	H2M::RefH2M<ImaGEShader> m_Shader_PBR_MRE;
	H2M::RefH2M<ImaGEShader> m_ShaderBackground;
	H2M::RefH2M<ImaGEShader> m_ShaderBlurHorizontal;
	H2M::RefH2M<ImaGEShader> m_ShaderBlurVertical;
