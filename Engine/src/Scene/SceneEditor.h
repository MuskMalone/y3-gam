...
public:
	...
	virtual void Render(Window* mainWindow, glm::mat4 projectionMatrix, std::string passType,
		std::map<std::string, H2M::RefH2M<ImaGEShader>> shaders, std::map<std::string, int> uniforms) override;
    inline H2M::RefH2M<ImaGEFramebuffer> GetRenderFramebuffer() { return m_RenderFramebuffer; };
...
private:
	...
	void RenderLightSources(H2M::RefH2M<ImaGEShader> shader);
	void RenderSkybox(H2M::RefH2M<ImaGEShader> shader);
	void RenderLineElements(H2M::RefH2M<ImaGEShader> shader, glm::mat4 projectionMatrix);
	void RenderFramebufferTextures(H2M::RefH2M<ImaGEShader> shader);
	void RenderGlassObjects(H2M::RefH2M<ImaGEShader> shader);
	void SetGeometry();
	...
	void SetUniformsShaderEditorPBR(H2M::RefH2M<ImaGEShader> shaderEditorPBR, H2M::RefH2M<ImaGETexture> texture, H2M::RefH2M<Material> material, SceneObject* sceneObject);
	void SetUniformsShaderEditor(H2M::RefH2M<ImaGEShader> shaderEditor, H2M::RefH2M<ImaGETexture> texture, SceneObject* sceneObject);
	void SetUniformsShaderSkinning(H2M::RefH2M<ImaGEShader> shaderSkinning, SceneObject* sceneObject, float runningTime);
	void SetUniformsShaderHybridAnimPBR(H2M::RefH2M<ImaGEShader> shaderHybridAnimPBR, H2M::RefH2M<ImaGETexture> texture, SceneObject* sceneObject, float runningTime);
	void SetUniformsShaderWater(H2M::RefH2M<ImaGEShader> shaderWater, SceneObject* sceneObject, glm::mat4& projectionMatrix);
...
private:
	...
	H2M::RefH2M<ImaGEFramebuffer> m_RenderFramebuffer;
	...
	H2M::RefH2M<ImaGETexture> m_LoadedTexture;
