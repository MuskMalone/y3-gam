...
{
    m_ShaderCubemaps = ImaGEShader::Create("Shaders/LearnOpenGL/6.2.cubemaps.vs", "Shaders/LearnOpenGL/6.2.cubemaps.fs");
    printf("SceneCubemaps: m_ShaderCubemaps compiled [programID=%d]\n", m_ShaderCubemaps->GetProgramID());

    m_ShaderCubemapsNanosuit = ImaGEShader::Create("Shaders/LearnOpenGL/6.2.cubemaps_nanosuit.vs", "Shaders/LearnOpenGL/6.2.cubemaps.fs");
    printf("SceneCubemaps: m_ShaderCubemapsNanosuit compiled [programID=%d]\n", m_ShaderCubemapsNanosuit->GetProgramID());

    m_ShaderSkybox = ImaGEShader::Create("Shaders/LearnOpenGL/6.2.skybox.vs", "Shaders/LearnOpenGL/6.2.skybox.fs");
    ...
    m_ShaderFramebuffersScene = ImaGEShader::Create("Shaders/framebuffers_scene.vs", "Shaders/framebuffers_scene.fs");
