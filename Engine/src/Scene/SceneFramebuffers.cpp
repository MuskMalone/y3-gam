...
void SceneFramebuffers::SetupShaders()
{
	...
	m_ShaderFramebuffersScreen = ImaGEShader::Create("Shaders/framebuffers_screen.vs", "Shaders/framebuffers_screen.fs");
...
void SceneFramebuffers::SetupFramebuffers()
{
	...
	m_Framebuffer = ImaGEFramebuffer::Create(SCR_WIDTH, SCR_HEIGHT);
