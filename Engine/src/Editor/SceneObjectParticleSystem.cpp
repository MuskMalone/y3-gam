...
SceneObjectParticleSystem::SceneObjectParticleSystem(bool instancedRendering, int maxInstances, H2M::CameraH2M* camera, CameraController* cameraController) : SceneObject()
{
    m_Camera = camera;
...
void SceneObjectParticleSystem::Regenerate()
{
    ...
    H2M::RefH2M<ImaGETexture> texture = ResourceManager::HotLoadTexture(m_Settings.textureName);
