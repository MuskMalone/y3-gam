...
public:
	...
	static H2M::RefH2M<ImaGEShader> GetShaderComposite();
	...
	static H2M::RefH2M<ImaGEShader> GetShaderSkybox() { return s_ShaderSkybox; }
	static H2M::RefH2M<ImaGEShader> GetShaderGrid() { return s_ShaderGrid; }
...
private:
	...
	static void RenderOutline(H2M::RefH2M<ImaGEShader> shader, H2M::EntityH2M entity, const glm::mat4& entityTransform, H2M::RefH2M<H2M::SubmeshH2M> submesh);
	static void UpdateShaderPBRUniforms(H2M::RefH2M<ImaGEShader> shaderHazelPBR, H2M::RefH2M<EnvMapMaterial> envMapMaterial);

public:
	static EnvMapEditorLayer* s_EditorLayer;

	// From EnvironmentMap
	static H2M::RefH2M<ImaGEShader> s_ShaderEquirectangularConversion;
	static H2M::RefH2M<ImaGEShader> s_ShaderEnvFiltering;
	static H2M::RefH2M<ImaGEShader> s_ShaderEnvIrradiance;
	static H2M::RefH2M<ImaGEShader> s_ShaderGrid;
	static H2M::RefH2M<ImaGEShader> s_ShaderSkybox;
