...
public:
	...
	void RenderSubmeshesShadowPass(H2M::RefH2M<ImaGEShader> shader);
	...
	// Getters
	H2M::RefH2M<ImaGEShader> GetShaderPBR_Anim();
	H2M::RefH2M<ImaGEShader> GetShaderPBR_Static();
...
public:
	...
	H2M::RefH2M<ImaGEFramebuffer> m_PostProcessingFramebuffer;
...
private:
	H2M::RefH2M<ImaGEShader> m_ShaderShadow;
	H2M::RefH2M<ImaGEShader> m_ShaderOmniShadow;
	H2M::RefH2M<ImaGEShader> m_ShaderPostProcessing;
	H2M::RefH2M<ImaGEShader> m_ShaderBloomBlur;
