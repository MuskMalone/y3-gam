...
void EnvMapEditorLayer::SetupRenderFramebuffer()
{
    ...
    m_RenderFramebuffer = ImaGEFramebuffer::Create(width, height);
    ...
    m_PostProcessingFramebuffer = ImaGEFramebuffer::Create(width, height);
...
H2M::EntityH2M EnvMapEditorLayer::LoadEntity(std::string fullPath)
{
    ...
    EnvMapSharedData::s_ShaderHazelPBR = ImaGEShaderLibrary::Get("HazelPBR_Static");
...
{
    H2M::RefH2M<ImaGEShader> shaderHazelPBR_Static = ImaGEShader::Create("Shaders/Hazel/HazelPBR_Static.vs", "Shaders/Hazel/HazelPBR.fs");
    ...
    // H2M::RefH2M<ImaGEShader> shaderHazelPBR_Static = ImaGEShader::Create("Shaders/Hazel/HazelPBR_Static.vs", "Shaders/Hazel/HazelPBR_Static_CSM.fs");
    // Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderHazelPBR_Static compiled [programID={0}]", shaderHazelPBR_Static->GetProgramID());

    H2M::RefH2M<ImaGEShader> shaderHazelPBR_Anim = ImaGEShader::Create("Shaders/Hazel/HazelPBR_Anim.vs", "Shaders/Hazel/HazelPBR.fs");
    Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderHazelPBR_Anim compiled [programID={0}]", shaderHazelPBR_Anim->GetProgramID());

    H2M::RefH2M<ImaGEShader> shaderRenderer2D_Line = ImaGEShader::Create("Shaders/Hazel/Renderer2D_Line.vs", "Shaders/Hazel/Renderer2D_Line.fs");
    Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderRenderer2D_Line compiled [programID={0}]", shaderRenderer2D_Line->GetProgramID());

    EnvMapSharedData::s_ShaderOutline = ImaGEShader::Create("Shaders/Hazel/Outline.vs", "Shaders/Hazel/Outline.fs");
    Log::GetLogger()->info("EnvMapEditorLayer: shaderOutline compiled [programID={0}]", EnvMapSharedData::s_ShaderOutline->GetProgramID());

    m_ShaderShadow = ImaGEShader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
    Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderShadow compiled [programID={0}]", m_ShaderShadow->GetProgramID());

    m_ShaderOmniShadow = ImaGEShader::Create("Shaders/omni_shadow_map.vert", "Shaders/omni_shadow_map.geom", "Shaders/omni_shadow_map.frag");
    Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderOmniShadow compiled [programID={0}]", m_ShaderOmniShadow->GetProgramID());

    m_ShaderPostProcessing = ImaGEShader::Create("Shaders/env_map_post_processing.vert", "Shaders/env_map_post_processing.frag");
    Log::GetLogger()->info("EnvMapEditorLayer: m_ShaderPostProcessing compiled [programID={0}]", m_ShaderPostProcessing->GetProgramID());

    m_ShaderBloomBlur = ImaGEShader::Create("Shaders/env_map_post_processing_bloom_blur.vert", "Shaders/env_map_post_processing_bloom_blur.frag");
    ...
    ImaGEShaderLibrary::Add(shaderHazelPBR_Static);
    ImaGEShaderLibrary::Add(shaderHazelPBR_Anim);
    ImaGEShaderLibrary::Add(shaderRenderer2D_Line);
    ImaGEShaderLibrary::Add(EnvMapSharedData::s_ShaderOutline);
    ImaGEShaderLibrary::Add(m_ShaderShadow);
    ImaGEShaderLibrary::Add(m_ShaderPostProcessing);
    ImaGEShaderLibrary::Add(m_ShaderBloomBlur);
}

void EnvMapEditorLayer::UpdateUniforms()
{
    /**** BEGIN Shaders/Hazel/SceneComposite ****/
    H2M::RefH2M<ImaGEShader> shaderComposite = EnvMapSceneRenderer::GetShaderComposite();
...
H2M::RefH2M<ImaGEShader> EnvMapEditorLayer::GetShaderPBR_Anim()
{
    return ImaGEShaderLibrary::Get("HazelPBR_Anim");
}

H2M::RefH2M<ImaGEShader> EnvMapEditorLayer::GetShaderPBR_Static()
{
    return ImaGEShaderLibrary::Get("HazelPBR_Static");
}
...
void EnvMapEditorLayer::RenderSubmeshesShadowPass(H2M::RefH2M<ImaGEShader> shader)
{
