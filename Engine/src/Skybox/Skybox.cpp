...
Skybox::Skybox(std::vector<std::string> faceLocations, bool flipVert)
{
	...
	imaGEShaderSpecification.VertexShaderPath = "Shaders/skybox.vert";
	imaGEShaderSpecification.FragmentShaderPath = "Shaders/skybox.frag";
	m_SkyShader = ImaGEShader::Create(imaGEShaderSpecification);
