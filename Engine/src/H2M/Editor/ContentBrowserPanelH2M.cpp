...
namespace H2M
{
	...
	ContentBrowserPanelH2M::ContentBrowserPanelH2M()
		: m_CurrentDirectory(s_AssetPath), m_CurrentDirectoryOld("")
	{
		...
		m_TextureDirectory = Texture2D_H2M::Create("Textures/UI/directory_modern_transparent.png", false);
		m_TextureFile = Texture2D_H2M::Create("Textures/UI/file_modern_transparent.png", false);
	}
	...
	void ContentBrowserPanelH2M::OnImGuiRender(bool* p_open)
	{
		...
		for (auto& directoryEntry : GetDirectoryEntriesCached(m_CurrentDirectory))
		{
...

			{
				...
				RefH2M<Texture2D_H2M> iconTexture = directoryEntry.is_directory() ? m_TextureDirectory : m_TextureFile;
	...
	std::vector<std::filesystem::directory_entry> ContentBrowserPanelH2M::GetDirectoryEntriesCached(std::filesystem::path currentDirectory)
	{
