...
namespace H2M
{
	...
	void SceneH2M::Init()
	{
		ImaGEShaderSpecification imaGEShaderSpec;

		switch (RendererAPI_H2M::Current())
		{
			case RendererAPITypeH2M::OpenGL:
				imaGEShaderSpec.ShaderType = ImaGEShaderSpecification::ShaderType::ImaGEShader;
				imaGEShaderSpec.VertexShaderPath = "Shaders/Hazel/Skybox.vs";
				imaGEShaderSpec.FragmentShaderPath = "Shaders/Hazel/Skybox.fs";
				break;
			//case RendererAPITypeH2M::Vulkan:
			//	imaGEShaderSpec.ShaderType = ImaGEShaderSpecification::ShaderType::HazelShader;
			//	imaGEShaderSpec.HazelShaderPath = "Resources/Shaders/Skybox.glsl";
			//	break;
			//case RendererAPITypeH2M::DX11:
			//	imaGEShaderSpec.ShaderType = ImaGEShaderSpecification::ShaderType::DX11Shader;
			//	imaGEShaderSpec.VertexShaderPath = "Shaders/HLSL/UnlitVertexShader.hlsl";
			//	imaGEShaderSpec.PixelShaderPath = "Shaders/HLSL/UnlitPixelShader.hlsl";
			//	break;
		}
		imaGEShaderSpec.ForceCompile = false;
		auto skyboxShader = ImaGEShader::Create(imaGEShaderSpec);
