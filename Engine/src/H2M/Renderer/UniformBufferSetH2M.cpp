...
namespace H2M
{
	...
	RefH2M<UniformBufferSetH2M> UniformBufferSetH2M::Create(uint32_t frames)
	{
		switch (RendererAPI_H2M::Current())
		{
		case RendererAPITypeH2M::None:   return RefH2M<UniformBufferSetH2M>();
		...
		return RefH2M<UniformBufferSetH2M>();
	}
