...
namespace H2M
{
	...
	void Renderer2D_H2M::InitObsolete()
	{
		...
		s_Data.QuadShader   = ImaGEShader::Create("Shaders/Hazel/Renderer2D_Quad.vs", "Shaders/Hazel/Renderer2D_Quad.fs");
		s_Data.CircleShader = ImaGEShader::Create("Shaders/Hazel/Renderer2D_Circle.vs", "Shaders/Hazel/Renderer2D_Circle.fs");
		s_Data.LineShader   = ImaGEShader::Create("Shaders/Hazel/Renderer2D_Line.vs", "Shaders/Hazel/Renderer2D_Line.fs");
