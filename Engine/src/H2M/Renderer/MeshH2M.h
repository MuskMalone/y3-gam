...
namespace H2M
{
	...
	{
	public:
		void Render(RefH2M<MeshH2M> parentMesh, RefH2M<ImaGEShader> shader, const glm::mat4& entityTransform, uint32_t samplerSlot,
		...
		void RenderOutline(RefH2M<MeshH2M> parentMesh, RefH2M<ImaGEShader> shader, const glm::mat4& entityTransform, EntityH2M entity);
	...
	public:
		...
		MeshH2M(const std::string& filename, RefH2M<ImaGEShader> shader, RefH2M<MaterialH2M> material, bool isAnimated);
	...
	private:
		...
		// Materials
		RefH2M<ImaGEShader> m_MeshShader;
