...
struct ImaGEShaderSpecification
{
...
class ImaGEShader : public H2M::ShaderH2M
{
public:
	// the ultimate Create method that can create both ImaGEShader and HazelShader shader types
	static H2M::RefH2M<ImaGEShader> Create(ImaGEShaderSpecification imaGEShaderSpecification);
	static H2M::RefH2M<ImaGEShader> Create(const char* vertexLocation, const char* fragmentLocation, bool forceCompile = false);
	static H2M::RefH2M<ImaGEShader> Create(const char* vertexLocation, const char* geometryLocation, const char* fragmentLocation, bool forceCompile = false);
	static H2M::RefH2M<ImaGEShader> Create(const char* computeLocation, bool forceCompile = false);

	ImaGEShader();
	ImaGEShader(const char* vertexLocation, const char* fragmentLocation, bool forceCompile = false);
	ImaGEShader(const char* vertexLocation, const char* geometryLocation, const char* fragmentLocation, bool forceCompile = false);
	ImaGEShader(const char* computeLocation, bool forceCompile = false);
	~ImaGEShader();
...
protected:
	...
	static std::vector<H2M::RefH2M<ImaGEShader>> s_AllShaders;
	...
	static ImaGEShaderSpecification s_Specification;
