...
public:
	...
	inline H2M::RefH2M<ImaGETexture> GetHeightMap() const { return m_TxHeightMap; };
	inline H2M::RefH2M<ImaGETexture> GetColorMap() const { return m_TxColorMap; };
...
private:
	...
	H2M::RefH2M<ImaGETexture> m_TxHeightMap;
	H2M::RefH2M<ImaGETexture> m_TxColorMap;
