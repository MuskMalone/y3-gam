...
SubTexture2D::SubTexture2D(H2M::RefH2M<ImaGETexture> texture, const glm::vec2& min, const glm::vec2& max)
	: m_Texture(texture)
{
...
SubTexture2D SubTexture2D::CreateFromCoords(H2M::RefH2M<ImaGETexture> texture, const glm::vec2& coords, const glm::vec2& cellSize, const glm::vec2& spriteSize)
{
