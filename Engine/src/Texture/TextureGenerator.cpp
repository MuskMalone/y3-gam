...
H2M::RefH2M<ImaGETexture> TextureGenerator::TextureFromHeightMap(float** noiseMap, const char* fileLocation, int width, int height)
{
...
H2M::RefH2M<ImaGETexture> TextureGenerator::TextureFromColorMap(glm::vec4* colorMap, const char* fileLocation, int width, int height)
{
	H2M::RefH2M<ImaGETexture> texture = ImaGETexture::Create(fileLocation, width, height, true, GL_LINEAR);
