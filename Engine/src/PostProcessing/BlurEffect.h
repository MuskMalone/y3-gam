...
public:
	...
	inline H2M::RefH2M<ImaGEFramebuffer> GetHorizontalFBO() { return m_HorizontalFBO; };
	inline H2M::RefH2M<ImaGEFramebuffer> GetVerticalFBO() { return m_VerticalFBO; };
...
private:
	...
	H2M::RefH2M<ImaGEFramebuffer> m_HorizontalFBO;
	H2M::RefH2M<ImaGEFramebuffer> m_VerticalFBO;

	int m_Width;
	int m_Height;
	int m_TextureID;

	H2M::RefH2M<ImaGEShader> m_ShaderHorizontalBlur;
	H2M::RefH2M<ImaGEShader> m_ShaderVerticalBlur;
