...
// Core Logging Macros
#define IMAGE_CORE_TRACE(...) Log::GetCoreLogger()->trace(__VA_ARGS__)
#define IMAGE_CORE_INFO(...)  Log::GetCoreLogger()->info(__VA_ARGS__)
#define IMAGE_CORE_WARN(...)  Log::GetCoreLogger()->warn(__VA_ARGS__)
#define IMAGE_CORE_ERROR(...) Log::GetCoreLogger()->error(__VA_ARGS__)
#define IMAGE_CORE_FATAL(...) Log::GetCoreLogger()->critical(__VA_ARGS__)
