...
class OpenGLImaGEFramebuffer : public ImaGEFramebuffer
{
public:
	OpenGLImaGEFramebuffer();
	OpenGLImaGEFramebuffer(unsigned int width, unsigned int height);
	OpenGLImaGEFramebuffer(FramebufferSpecification spec);
	~OpenGLImaGEFramebuffer();
	...
	// virtual/abstract methods from ImaGEFramebuffer
	...
	static H2M::RefH2M<ImaGEFramebuffer> Create(const FramebufferSpecification& spec);
