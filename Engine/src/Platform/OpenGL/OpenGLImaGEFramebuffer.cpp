#include "OpenGLImaGEFramebuffer.h"
...
OpenGLImaGEFramebuffer::OpenGLImaGEFramebuffer()
{
	m_FBO = 0;
...
OpenGLImaGEFramebuffer::OpenGLImaGEFramebuffer(unsigned int width, unsigned int height)
	: OpenGLImaGEFramebuffer()
{
	m_FramebufferSpecs.Width = width;
	m_FramebufferSpecs.Height = height;
}

OpenGLImaGEFramebuffer::OpenGLImaGEFramebuffer(FramebufferSpecification spec)
{
	m_FramebufferSpecs = spec;
	OpenGLImaGEFramebuffer(spec.Width, spec.Height);
}

void OpenGLImaGEFramebuffer::AddColorAttachmentSpecification(unsigned int width, unsigned int height, AttachmentType attachmentType, AttachmentFormat attachmentFormat)
{
...
void OpenGLImaGEFramebuffer::AddDepthAttachmentSpecification(unsigned int width, unsigned int height, AttachmentType attachmentType, AttachmentFormat attachmentFormat)
{
...
void OpenGLImaGEFramebuffer::AddColorAttachment(FramebufferSpecification specs)
{
	m_ColorAttachmentSpecs.push_back(specs);
}

void OpenGLImaGEFramebuffer::AddDepthAttachment(FramebufferSpecification specs)
{
	if (m_RenderbufferAttachmentSpec.size()) {
		Log::GetLogger()->error("Depth attachment specification already exists!");
	}
...
void OpenGLImaGEFramebuffer::Generate(unsigned int width, unsigned int height)
{
	if (m_FBO) Release();
	...
	for (FramebufferSpecification attachmentSpecs : m_ColorAttachmentSpecs)
	{
		...
		case AttachmentFormat::RED_INTEGER:
			...
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate: AttachmentFormat: {0}, Multisample: {1}, colorAttachmentIndex: {2}, Size: [{3}x{4}]",
	...
	if (m_RenderbufferAttachmentSpec.size()) {
		...
		case AttachmentFormat::Depth:
			...
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate [AttachmentFormat::Depth, Multisample: {0}, {1}x{2}]", m_Multisample, width, height);
			break;
		case AttachmentFormat::DepthStencil:
			...
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate [AttachmentFormat::DepthStencil, Multisample: {0}, {1}x{2}]", m_Multisample, width, height);
			break;
		case AttachmentFormat::Depth_24:
			CreateAttachmentDepth(m_FramebufferSpecs.Width, m_FramebufferSpecs.Height, m_Multisample, attachmentSpecs.attachmentType, attachmentSpecs.attachmentFormat);
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate [AttachmentFormat::Depth_24, Multisample: {0}, {1}x{2}]", m_Multisample, width, height);
			break;
		case AttachmentFormat::Depth_24_Stencil_8:
			CreateAttachmentDepthAndStencil(m_FramebufferSpecs.Width, m_FramebufferSpecs.Height, m_Multisample, attachmentSpecs.attachmentType, attachmentSpecs.attachmentFormat);
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate [AttachmentFormat::Depth_24_Stencil_8, Multisample: {0}, {1}x{2}]", m_Multisample, width, height);
			break;
		case AttachmentFormat::Stencil:
			...
			Log::GetLogger()->debug("OpenGLImaGEFramebuffer::Generate [AttachmentFormat::Stencil, Multisample: {0}, {1}x{2}]", m_Multisample, width, height);
			break;
		default:
...
void OpenGLImaGEFramebuffer::Release()
{
	// Log::GetLogger()->info("OpenGLImaGEFramebuffer::Release");
...
void OpenGLImaGEFramebuffer::CreateTextureAttachmentColor(unsigned int width, unsigned int height, bool isMultisample,
...
void OpenGLImaGEFramebuffer::CreateAttachmentDepth(unsigned int width, unsigned int height, bool isMultisample,
...
void OpenGLImaGEFramebuffer::CreateAttachmentStencil(unsigned int width, unsigned int height, bool isMultisample,
	AttachmentType attachmentType, AttachmentFormat attachmentFormat)
{
	if (attachmentType == AttachmentType::Texture)
...
void OpenGLImaGEFramebuffer::CreateAttachmentDepthAndStencil(unsigned int width, unsigned int height, bool isMultisample,
	AttachmentType attachmentType, AttachmentFormat attachmentFormat)
{
	if (attachmentType == AttachmentType::Texture)
...
void OpenGLImaGEFramebuffer::Bind() const
{
...
void OpenGLImaGEFramebuffer::Unbind() const
{
...
void OpenGLImaGEFramebuffer::Bind(unsigned int width, unsigned int height)
{
	m_FramebufferSpecs.Width = width;
	m_FramebufferSpecs.Height = height;
...
void OpenGLImaGEFramebuffer::Unbind(unsigned int width, unsigned int height)
{
	m_FramebufferSpecs.Width = width;
	m_FramebufferSpecs.Height = height;
...
bool OpenGLImaGEFramebuffer::CheckStatus()
{
	return glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE;
}

H2M::RefH2M<FramebufferTexture> OpenGLImaGEFramebuffer::GetTextureAttachmentColor(unsigned int orderID)
{
...
H2M::RefH2M<Attachment> OpenGLImaGEFramebuffer::GetAttachmentDepth()
{
...
H2M::RefH2M<Attachment> OpenGLImaGEFramebuffer::GetAttachmentStencil()
{
...
H2M::RefH2M<Attachment> OpenGLImaGEFramebuffer::GetAttachmentDepthAndStencil()
{
...
H2M::RefH2M<ImaGEFramebuffer> OpenGLImaGEFramebuffer::Create(const FramebufferSpecification& spec)
{
	return ImaGEFramebuffer::Create(spec);
}

void OpenGLImaGEFramebuffer::Clear()
{
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT);
}

void OpenGLImaGEFramebuffer::Resize(uint32_t width, uint32_t height)
{
...
void OpenGLImaGEFramebuffer::ClearAttachment(uint32_t attachmentIndex, int value)
{
...
uint32_t OpenGLImaGEFramebuffer::GetColorAttachmentRendererID(uint32_t index) const
{
...
void OpenGLImaGEFramebuffer::Resize(uint32_t width, uint32_t height, bool forceRecreate)
{
	Resize(width, height);
}

int OpenGLImaGEFramebuffer::ReadPixel(uint32_t attachmentIndex, int x, int y)
{
...
void OpenGLImaGEFramebuffer::BindTexture(uint32_t attachmentIndex, uint32_t slot) const
{
...
uint32_t OpenGLImaGEFramebuffer::GetRendererID() const
{
	return m_FBO;
}

H2M::RefH2M<H2M::Image2D_H2M> OpenGLImaGEFramebuffer::GetImage(uint32_t attachmentIndex) const
{
	return H2M::RefH2M<H2M::Image2D_H2M>();
}

H2M::RefH2M<H2M::Image2D_H2M> OpenGLImaGEFramebuffer::GetDepthImage() const
{
	return H2M::RefH2M<H2M::Image2D_H2M>();
}

//	uint32_t OpenGLImaGEFramebuffer::GetColorAttachmentRendererID() const
//	{
//		return H2M::RendererID();
//	}

//	uint32_t OpenGLImaGEFramebuffer::GetDepthAttachmentRendererID() const
//	{
//		return H2M::RendererID();
//	}

const H2M::FramebufferSpecificationH2M& OpenGLImaGEFramebuffer::GetSpecification() const
{
