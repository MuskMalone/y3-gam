...
class OpenGLImaGEShader : public ImaGEShader
{
public:
	OpenGLImaGEShader();
	OpenGLImaGEShader(const char* vertexLocation, const char* fragmentLocation, bool forceCompile = false);
	OpenGLImaGEShader(const char* vertexLocation, const char* geometryLocation, const char* fragmentLocation, bool forceCompile = false);
	OpenGLImaGEShader(const char* computeLocation, bool forceCompile = false);

	static H2M::RefH2M<OpenGLImaGEShader> Create(const char* vertexLocation, const char* fragmentLocation, bool forceCompile = false);
	static H2M::RefH2M<OpenGLImaGEShader> Create(const char* vertexLocation, const char* geometryLocation, const char* fragmentLocation, bool forceCompile = false);
	static H2M::RefH2M<OpenGLImaGEShader> Create(const char* computeLocation, bool forceCompile = false);
