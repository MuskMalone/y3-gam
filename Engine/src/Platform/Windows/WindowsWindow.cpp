...
void WindowsWindow::Init()
{
	...
	//	m_SwapChain.Init(context->GetInstance(), context->GetDevice());
	...
	//	H2M::VulkanAllocatorH2M::Init(context->GetDevice());
	...
	// The old ImaGEEngine method of handling events
...
{
	// not implemented/used in old ImaGEEngine method of handling events
}
