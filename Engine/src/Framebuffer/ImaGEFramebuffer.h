...
class ImaGEFramebuffer : public H2M::FramebufferH2M
{
public:
	static H2M::RefH2M<ImaGEFramebuffer> Create(uint32_t width, uint32_t height);
	static H2M::RefH2M<ImaGEFramebuffer> Create(FramebufferSpecification spec);
	...
	// virtual methods ImaGEFramebufer
