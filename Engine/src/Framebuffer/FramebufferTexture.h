...
public:
	...
	FramebufferTexture(ImaGETexture::Specification spec, unsigned int orderID); // constructor for fully customizable framebuffer texture
...
public:
	ImaGETexture::Specification m_Spec;
