...
{
	H2M::RefH2M<ImaGEShader> shaderMain = ImaGEShader::Create("Shaders/shader.vert", "Shaders/shader.frag");
	...
	H2M::RefH2M<ImaGEShader> shaderRenderInstanced  = ImaGEShader::Create("Shaders/render_instanced.vs", "Shaders/render_instanced.fs");
	...
	H2M::RefH2M<ImaGEShader> shaderBasic = ImaGEShader::Create("Shaders/basic.vs", "Shaders/basic.fs");
	...
	H2M::RefH2M<ImaGEShader> shaderMarchingCubes = ImaGEShader::Create("Shaders/marching_cubes.vs", "Shaders/marching_cubes.fs");
	...
	H2M::RefH2M<ImaGEShader> shaderShadowMap = ImaGEShader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
	...
	H2M::RefH2M<ImaGEShader> shaderOmniShadow = ImaGEShader::Create("Shaders/omni_shadow_map.vert", "Shaders/omni_shadow_map.geom", "Shaders/omni_shadow_map.frag");
	...
	H2M::RefH2M<ImaGEShader> shaderWater = ImaGEShader::Create("Shaders/water.vert", "Shaders/water.frag");
...
void RendererVoxelTerrain::RenderPassShadow(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
	...
	H2M::RefH2M<ImaGEShader> shaderShadowMap = RendererBasic::GetShaders()["shadow_map"];
...
void RendererVoxelTerrain::RenderPassWaterReflection(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
	...
	H2M::RefH2M<ImaGEShader> shaderRenderInstanced = RendererBasic::GetShaders()["render_instanced"];
...
void RendererVoxelTerrain::RenderPassMain(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
	...
	H2M::RefH2M<ImaGEShader> shaderMarchingCubes = RendererBasic::GetShaders()["marching_cubes"];
	...
	/**** BEGIN shaderBasic ****/
	H2M::RefH2M<ImaGEShader> shaderBasic = RendererBasic::GetShaders()["basic"];
	shaderBasic->Bind();
	...
	H2M::RefH2M<ImaGEShader> shaderWater = RendererBasic::GetShaders()["water"];
	shaderWater->Bind();
