...
void RendererPBR::SetShaders()
{
	...
	H2M::RefH2M<ImaGEShader> shaderDirectionalShadow = ImaGEShader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
	...
	H2M::RefH2M<ShaderPBR> shaderPBR = H2M::RefH2M<ShaderPBR>::Create("Shaders/PBR.vert", "Shaders/PBR.frag");
...
void RendererPBR::RenderPassMain(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
	...
	H2M::RefH2M<ImaGEShader> shaderPBR = RendererBasic::GetShaders()["pbr"];
