...
{
    H2M::RefH2M<OpenGLImaGEShader> shaderEditor = ImaGEShader::Create("Shaders/editor_object.vs", "Shaders/editor_object.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderEditorPBR = ImaGEShader::Create("Shaders/editor_object.vs", "Shaders/PBR/editor_object_pbr.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderSkinning = ImaGEShader::Create("Shaders/OGLdev/skinning.vs", "Shaders/OGLdev/skinning.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderHybridAnimPBR = ImaGEShader::Create("Shaders/HybridAnimPBR.vs", "Shaders/HybridAnimPBR.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderShadowMap = ImaGEShader::Create("Shaders/directional_shadow_map.vert", "Shaders/directional_shadow_map.frag");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderOmniShadowMap = ImaGEShader::Create("Shaders/omni_shadow_map.vert", "Shaders/omni_shadow_map.geom", "Shaders/omni_shadow_map.frag");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderWater = ImaGEShader::Create("Shaders/water.vert", "Shaders/water.frag");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderBackground = ImaGEShader::Create("Shaders/LearnOpenGL/2.2.2.background.vs", "Shaders/LearnOpenGL/2.2.2.background.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderBasic = ImaGEShader::Create("Shaders/basic.vs", "Shaders/basic.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderGizmo = ImaGEShader::Create("Shaders/gizmo.vs", "Shaders/gizmo.fs");
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderGlass = ImaGEShader::Create("Shaders/glass.vs", "Shaders/glass.fs");
...
void RendererEditor::RenderPassShadow(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderShadowMap = RendererBasic::GetShaders()["shadow_map"];
...
void RendererEditor::RenderPassOmniShadow(PointLight* light, Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<ImaGEShader> shaderOmniShadow = RendererBasic::GetShaders()["omni_shadow_map"];
...
void RendererEditor::RenderPassWaterReflection(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderEditor = RendererBasic::GetShaders()["editor_object"];
    shaderEditor->Bind();
    ...
    H2M::RefH2M<ImaGEShader> shaderEditorPBR = RendererBasic::GetShaders()["editor_object_pbr"];
    shaderEditorPBR->Bind();
    ...
    H2M::RefH2M<ImaGEShader> shaderSkinning = RendererBasic::GetShaders()["skinning"];
    shaderSkinning->Bind();
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderHybridAnimPBR = RendererBasic::GetShaders()["hybrid_anim_pbr"];
    shaderHybridAnimPBR->Bind();
...
void RendererEditor::RenderPassWaterRefraction(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderEditorPBR = RendererBasic::GetShaders()["editor_object_pbr"];
    shaderEditorPBR->Bind();
    shaderEditorPBR->SetMat4("view", scene->GetCamera()->GetViewMatrix());
    shaderEditorPBR->SetMat4("projection", projectionMatrix);
    shaderEditorPBR->SetFloat3("eyePosition", scene->GetCamera()->GetPosition());
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderSkinning = RendererBasic::GetShaders()["skinning"];
    shaderSkinning->Bind();
    shaderSkinning->SetMat4("view", scene->GetCamera()->GetViewMatrix());
    shaderSkinning->SetMat4("projection", projectionMatrix);
...
void RendererEditor::RenderPassMain(Window* mainWindow, Scene* scene, glm::mat4 projectionMatrix)
{
    ...
    H2M::RefH2M<ImaGEFramebuffer> renderFramebuffer;
...
void RendererEditor::RenderStageSetUniforms(Scene* scene, glm::mat4* projectionMatrix)
{
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderOmniShadowMap = RendererBasic::GetShaders()["omni_shadow_map"];
    ...
    /**** Begin shaderWater ****/
    H2M::RefH2M<OpenGLImaGEShader> shaderWater = RendererBasic::GetShaders()["water"];
    shaderWater->Bind();
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderBackground = RendererBasic::GetShaders()["background"];
    ...
    H2M::RefH2M<OpenGLImaGEShader> shaderBasic = RendererBasic::GetShaders()["basic"];
    shaderBasic->Bind();
    ...
    /**** Begin gizmo shader ****/
    H2M::RefH2M<OpenGLImaGEShader> shaderGizmo = RendererBasic::GetShaders()["gizmo"];
    shaderGizmo->Bind();
    ...
    /**** Begin glass ****/
    H2M::RefH2M<OpenGLImaGEShader> shaderGlass = RendererBasic::GetShaders()["glass"];
    shaderGlass->Bind();
