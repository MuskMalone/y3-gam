...
public:
	...
	static void AppendRendererInfo(WindowSpecification& windowSpecification);
	...
	static std::map<std::string, H2M::RefH2M<ImaGEShader>>& GetShaders() { return s_Shaders; };
...
public:
	...
	static std::map<std::string, H2M::RefH2M<ImaGEShader>> s_Shaders;
