...
public:
	...
	inline H2M::RefH2M<ImaGETexture> GetTextureAlbedo()    const { return m_TextureAlbedo;    };
	inline H2M::RefH2M<ImaGETexture> GetTextureNormal()    const { return m_TextureNormal;    };
	inline H2M::RefH2M<ImaGETexture> GetTextureMetallic()  const { return m_TextureMetallic;  };
	inline H2M::RefH2M<ImaGETexture> GetTextureRoughness() const { return m_TextureRoughness; };
	inline H2M::RefH2M<ImaGETexture> GetTextureEmissive()  const { return m_TextureEmissive;  };
	inline H2M::RefH2M<ImaGETexture> GetTextureAO()        const { return m_TextureAO;        };
...
private:
	H2M::RefH2M<ImaGETexture> m_TextureAlbedo;
	H2M::RefH2M<ImaGETexture> m_TextureNormal;
	H2M::RefH2M<ImaGETexture> m_TextureMetallic;
	H2M::RefH2M<ImaGETexture> m_TextureRoughness;
	H2M::RefH2M<ImaGETexture> m_TextureEmissive;
	H2M::RefH2M<ImaGETexture> m_TextureAO;

	H2M::RefH2M<ImaGETexture> m_TexturePlaceholder;
