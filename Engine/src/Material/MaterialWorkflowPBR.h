...
private:
	...
	// Shaders
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderEquirectangularToCubemap;
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderIrradiance;
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderPrefilter;
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderBRDF;
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderHorizontalBlur;
	H2M::RefH2M<OpenGLImaGEShader> m_ShaderVerticalBlur;
