...
void ScriptManager::AddInternalCalls()
{
  ...
  //// Get Functions
  mono_add_internal_call("Image.Mono.InternalCalls::GetTranslation", Mono::GetTranslation);
  ...
  mono_add_internal_call("Image.Mono.InternalCalls::GetScale", Mono::GetScale);

  //// Set Functions
  mono_add_internal_call("Image.Mono.InternalCalls::SetTranslation", Mono::SetTranslation);
  //mono_add_internal_call("Image.InternalCalls::SetRotation", SetRotation);
  mono_add_internal_call("Image.Mono.InternalCalls::SetScale", Mono::SetScale);
}
...
void Mono::SetTranslation(ECS::Entity::EntityID entity, glm::vec3 posAdjustment)
{
  Component::Transform& oldTransform = ECS::Entity(entity).GetComponent<Component::Transform>();
  oldTransform.worldPos = posAdjustment;
  oldTransform.modified = true;
}

void Mono::SetScale(ECS::Entity::EntityID entity, glm::vec3 scaleAdjustment)
{
  Component::Transform& oldTransform = ECS::Entity(entity).GetComponent<Component::Transform>();
  oldTransform.scale = scaleAdjustment;
}

void Mono::SetRotation(ECS::Entity::EntityID entity, glm::vec3 rotAdjustment)
{
  Component::Transform& oldTransform = ECS::Entity(entity).GetComponent<Component::Transform>();
  oldTransform.rotation = rotAdjustment;
}

glm::vec3 Mono::GetTranslation(ECS::Entity::EntityID entity)
{
