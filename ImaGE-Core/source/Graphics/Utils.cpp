...
namespace Graphics {
    namespace Utils {
        ...
        namespace Framebuffer {
            ...
            void AttachColorTexture(uint32_t id, GLenum intFmt, GLenum fmt, uint32_t width, uint32_t height, int index, GLenum type) {
            ...
            void AttachShadowMapTexture(uint32_t& id, uint32_t width, uint32_t height) {
              ...
              // apparently setting compare mode breaks shadows on school PC???
