...
namespace Graphics {
	...
	void RenderAPI::DrawIndicesInstancedBaseVertex(std::shared_ptr<VertexArray> const& vao, uint32_t idxCount, uint32_t instanceCount, uint32_t indexOffset, int baseVertex, int baseInstance){
		vao->Bind();
