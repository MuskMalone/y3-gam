      ...
      if (ImGui::BeginMenuBar())
      {
        ...
        BeginDisabledBlock(noScene);
          ...
          if (mSceneManager.GetSceneState() & Scenes::SceneState::PLAYING) {
            if (ImGui::Button(ICON_FA_STOP) || (Input::InputManager::GetInstance().IsKeyPressed(KEY_CODE::KEY_LEFT_CONTROL) && Input::InputManager::GetInstance().IsKeyTriggered(KEY_CODE::KEY_O)))
            {
              isCursorLocked = !isCursorLocked;
              QUEUE_EVENT(Events::LockMouseEvent, isCursorLocked);
            }

            if (ImGui::Button(ICON_FA_STOP) || (Input::InputManager::GetInstance().IsKeyPressed(KEY_CODE::KEY_LEFT_CONTROL) && Input::InputManager::GetInstance().IsKeyTriggered(KEY_CODE::KEY_P))) {
              wasRunning = true;
          ...
          else
          {
            ...
            if (mSceneManager.GetSceneState() != Scenes::SceneState::PLAYING && !wasRunning) {
              if (ImGui::Button(ICON_FA_PLAY) || (Input::InputManager::GetInstance().IsKeyPressed(KEY_CODE::KEY_LEFT_CONTROL) && Input::InputManager::GetInstance().IsKeyTriggered(KEY_CODE::KEY_P))) {
                isCursorLocked = true;
                QUEUE_EVENT(Events::LockMouseEvent, isCursorLocked);
