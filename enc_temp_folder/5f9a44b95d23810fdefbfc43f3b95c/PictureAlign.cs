...
public class PictureAlign : Entity
{
  ...
  public Vector3 bigBorderScale = new Vector3(33.961f, 19.5f, -0.800f);
  public Vector3 smallBorderPos = new Vector3(10.100f, 0.150f, -0.010f);
  public Vector3 bigBorderPos = new Vector3(0.230f, 0.50f, -0.010f);
      ...
      if (isTransitioning)
      {
        ...
        else if (picture == "MotherBehindGatePainting")
        {
          ...
          if (alphaProgress >= 1.0f && !washingDown)
          {
            ...
            {
              transition.StartTransition(false, 0.25f, Transition.TransitionType.FADE);
              currentAlpha = 1f;
