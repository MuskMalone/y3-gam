...
namespace Events
{
  ...
  {
  public:
    KeyTriggeredEvent(KEY_CODE code) : Event(EventType::KEY_TRIGGERED), m_code{ code } {}
  ...
  {
  public:
    KeyHeldEvent(KEY_CODE code) : Event(EventType::KEY_HELD), m_code{ code } {}
    inline KEY_CODE GetKey() const noexcept { return m_code; }
  ...
  {
  public:
    KeyReleasedEvent(KEY_CODE code) : Event(EventType::KEY_RELEASED), m_code{ code } {}
    inline KEY_CODE GetKey() const noexcept { return m_code; }
  ...
  {
  public:
    MouseTriggeredEvent(KEY_CODE code) : Event(EventType::MOUSE_TRIGGERED), m_code{ code } {}
    inline KEY_CODE GetKey() const noexcept { return m_code; }
  ...
  {
  public:
    MouseHeldEvent(KEY_CODE code) : Event(EventType::MOUSE_HELD), m_code{ code } {}
    inline KEY_CODE GetKey() const noexcept { return m_code; }
  ...
  {
  public:
    MouseReleasedEvent(KEY_CODE code) : Event(EventType::MOUSE_RELEASED), m_code{ code } {}
    inline KEY_CODE GetKey() const noexcept { return m_code; }
