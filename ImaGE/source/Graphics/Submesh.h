namespace Graphics{
    struct Submesh {
        ...
        // Constructors
        Submesh() : baseVtx{}, baseIdx{}, idxCount{}, materialIdx{}, transform{glm::mat4{ 1.f }} {}
        Submesh(uint32_t vtx, uint32_t idx, uint32_t idxCnt, uint32_t matIdx, const glm::mat4& xform)
            : baseVtx{ vtx }, baseIdx{ idx }, idxCount{ idxCnt }, materialIdx{ matIdx }, transform{ xform } {}
    };
}